...
public class InscriptionConsultantService implements InscriptionConsultantUseCase {
    private final Repository repository;
    private final EventDispatcher<? super Event> eventDispatcher;

    public InscriptionConsultantService(Repository repository, EventDispatcher<? super Event> eventDispatcher) {
